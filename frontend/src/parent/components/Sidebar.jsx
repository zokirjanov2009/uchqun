...
const Sidebar = ({ onClose }) => {
  ...
  const navigation = [
    ...
    { name: 'Child Profile', href: '/parent/child', icon: UserCircle },
    { name: 'Activities', href: '/parent/activities', icon: ClipboardList },
    { name: 'Meals', href: '/parent/meals', icon: Utensils },
    { name: 'Media', href: '/parent/media', icon: ImageIcon },
    { name: 'Settings', href: '/parent/settings', icon: Settings },
    { name: 'Help', href: '/parent/help', icon: HelpCircle },
  ];
