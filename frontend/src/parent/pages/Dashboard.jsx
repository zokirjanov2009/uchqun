...
const Dashboard = () => {
  ...
  const quickActions = [
    { to: '/parent/activities', title: 'Schedule', icon: Calendar },
    { to: '/parent/media', title: 'Media', icon: Video },
    { to: '/parent/activities', title: 'Music', icon: Music },
    { to: '/parent/child', title: 'Progress', icon: TrendingUp },
  ];
